-- Set up the options and keymaps for the editor
require("core.options")  -- Your general Neovim settings (e.g., options, configurations)
require("core.keymaps")  -- Your key mappings
